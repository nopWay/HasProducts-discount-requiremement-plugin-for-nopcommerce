    ...
    public partial class HasProductsDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        ...
        public string GetConfigurationUrl(int discountId, int? discountRequirementId)
        {
            ...
            return urlHelper.Action("Configure", "DiscountRulesHasProducts",
                new { discountId, discountRequirementId }, _webHelper.CurrentRequestProtocol).TrimStart('/');
        }
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasProducts.Show.Selected", "Show only selected products ({0})");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasProducts.Hide.Selected", "Back | Selected products ({0})");
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasProducts.Show.Selected");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasProducts.Hide.Selected");
